...
// import { validateMatchInput } from ".";

// export const matchSolver = async (problem: any, solvers: any[]) => {
//   const prompt = `
// You are an expert matching system.

// Your task is to match the best solvers to a problem.

// PROBLEM:
// Title: ${problem.refinedTitle || problem.title}
// Description: ${problem.refinedDesc || problem.desc}
// Tags: ${problem.tags?.join(", ") || "none"}

// SOLVERS:
// ${JSON.stringify(solvers, null, 2)}
